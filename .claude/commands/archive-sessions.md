...
3. **Scan session files:**
   - List all files in `/mnt/nas/Files/06 Archive/Claude Sessions/`
...
4. **Create year directories:**
   - For each year found in files-to-archive:
     - Create directory: `/mnt/nas/Files/06 Archive/Claude Sessions/YYYY/`
     - Use `mkdir -p` (safe if exists)

5. **Move files** (or display if dry-run):
   - For each file marked for archival:
     - Source: `/mnt/nas/Files/06 Archive/Claude Sessions/YYYY-MM-DD.md`
     - Destination: `/mnt/nas/Files/06 Archive/Claude Sessions/YYYY/YYYY-MM-DD.md`
...
**Directories created:**
- `/mnt/nas/Files/06 Archive/Claude Sessions/YYYY/`
