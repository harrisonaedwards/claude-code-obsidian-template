...
4. **Update project file:**
   - Read `/mnt/nas/Files/03 Projects/[Project Name].md`
...
5. **Move project file to archive:**
   - Create archive directory if needed: `mkdir -p "/mnt/nas/Files/06 Archive/Projects/YYYY"`
   - Move file: `/mnt/nas/Files/03 Projects/[Project Name].md` → `/mnt/nas/Files/06 Archive/Projects/YYYY/[Project Name].md`
