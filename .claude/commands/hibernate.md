...
2. **Read comprehensive context:**
   - `/mnt/nas/Files/01 Now/Works in Progress.md` - active projects
...
5. **Generate hibernate snapshot** at `/mnt/nas/Files/06 Archive/Hibernate Snapshots/YYYY-MM-DD-hibernate.md`:
