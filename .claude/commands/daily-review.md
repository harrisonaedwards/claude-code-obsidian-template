...
2. **Check if today's session summary exists:**
   - Look for `/mnt/nas/Files/06 Archive/Claude Sessions/YYYY-MM-DD.md` (using current date from step 1)
...
4. **Ensure directory exists:**
   - Check if `/mnt/nas/Files/06 Archive/Daily Reviews/` directory exists
   - If not, create it: `mkdir -p "/mnt/nas/Files/06 Archive/Daily Reviews"`
   - This prevents first-run failures

5. **Generate daily summary:**

Create a file at `/mnt/nas/Files/06 Archive/Daily Reviews/YYYY-MM-DD.md` (using current date from step 1):
